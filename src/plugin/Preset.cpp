...
juce::ValueTree Preset::loadSysexProgramData(std::vector<uint8_t> data) {
...
juce::ValueTree Preset::loadSysexProgramBank(std::vector<uint8_t> sysexData) {
    ...
    for (int k = 0; k < 40; k++) {
        ...
        programBank.appendChild(Preset::loadSysexProgramData(programData), nullptr);
    }
